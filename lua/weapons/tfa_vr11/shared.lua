...
SWEP.Primary.Ammo			= "Life Cells"					-- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.IronSightsPos = Vector(-4.915, 0.079, 2.135)
SWEP.IronSightsAng = Vector(-6.5, -2.852, 0)
...
if self.Ispackapunched == 1 then
		...
		self.Owner:GetViewModel():SetSubMaterial(1, "models/weapons/common/bo1_pap_camo_c.vmt")
else
