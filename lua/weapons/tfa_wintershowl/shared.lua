...
SWEP.Primary.Ammo = "Cold Cells" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
if SERVER then
self.Primary.NZMaxAmmo = 24
end
BaseClass.NZMaxAmmo( self, maxammo ) 
end


--ParticleEffectAttach("ice_smoke_cloud",PATTACH_POINT_FOLLOW,ent,0)
