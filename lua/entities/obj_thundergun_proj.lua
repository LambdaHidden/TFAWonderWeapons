...
ENT.TrailPCF = "smoke_base"
ENT.TrailSND = "ambient/wind/wind_hit1.wav"
ENT.Damage = 0
ENT.HasTimeout = true
ENT.TimeoutPeriod = 0.6
ENT.MoveSpeed = 2000
...
function ENT:OnCollide(ent,data,physobj,NoData) -- OnCollide(CollisionData data, Physics Object physobj, Boolean NoData)
